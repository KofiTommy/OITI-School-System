...
//EXPORT_TABLES("localhost","root","june12","xshopmanager_supermarket_db" );
EXPORT_TABLES($_Server,$_User,$_Password,$_Database);
...
function EXPORT_TABLES($host,$user,$pass,$name,       $tables=false, $backup_name=false){ 
    ...
    $backup_name = $backup_name ? $backup_name : $name."_".$_SESSION['branch']."___(".date('H-i-s')."_".date('d-m-Y').")__rand".rand(1,11111111).".sql";
